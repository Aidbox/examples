...
exclusion_evidence AS (
    ...
    UNION ALL SELECT DISTINCT patient_id, 'pregnancy_renal' AS exclusion_pathway, 'summary' AS exc_resource_type, NULL::text AS exc_resource_id FROM pregnancy_renal
    UNION ALL SELECT DISTINCT patient_id, 'esrd_procedures' AS exclusion_pathway, 'summary' AS exc_resource_type, NULL::text AS exc_resource_id FROM esrd_procedures
    UNION ALL SELECT DISTINCT patient_id, 'esrd_encounter' AS exclusion_pathway, 'summary' AS exc_resource_type, NULL::text AS exc_resource_id FROM esrd_encounter
