...
exclusion_evidence AS (
    ...
    UNION ALL SELECT DISTINCT patient_id, 'absence_of_cervix' AS exclusion_pathway, 'summary' AS exc_resource_type, NULL::text AS exc_resource_id FROM absence_of_cervix
)
