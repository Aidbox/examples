...
exclusion_evidence AS (
    ...
    UNION ALL SELECT DISTINCT patient_id, 'mastectomy_exclusion' AS exclusion_pathway, 'summary' AS exc_resource_type, NULL::text AS exc_resource_id FROM mastectomy_exclusion
