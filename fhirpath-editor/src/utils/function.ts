...
import { primitiveTypeMap } from "@/utils/fhir";
...
function fn(
  ...
  input: IType,
  args: IFunctionArg[],
  returnType: IType | IFunctionReturnType,
): IFunctionMetadata {
  return {
    name,
    input,
...
export const functionMetadata: IFunctionMetadata[] = [
...
export function suggestFunctionsForInputType(input: IType) {
...
export function suggestArgumentTypesForFunction(
  name: FunctionName,
  inputType: IType,
  knownArgumentTypes: IType[] | undefined,
): IType[] {
