...
import { IQuantityToken, ITokenComponentProps } from "@/types/internal";
...
const QuantityToken = React.forwardRef<HTMLElement, ITokenComponentProps>(
  ({ bindingId, tokenIndex }, forwardedRef) => {
    ...
    return (
      <div
        className="flex items-center gap-1 px-1 py-0.5 rounded bg-slate-50 border border-slate-300 text-slate-600"
