...
export interface observation_bp {
...
export const attach_observation_bp_to_Observation = (resource: Observation, profile: observation_bp): Observation => {
    return {
        ...resource,
        meta: {
...
export const extract_observation_bp_from_Observation = (resource: Observation): observation_bp => {
    ...
    return {
        ...
        code: resource.code,
        subject: resource.subject as observation_bp['subject'],
