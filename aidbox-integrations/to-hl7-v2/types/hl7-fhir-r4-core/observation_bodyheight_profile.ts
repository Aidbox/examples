...
export const attach_observation_bodyheight_to_Observation = (resource: Observation, profile: observation_bodyheight): Observation => {
    return {
        ...resource,
        meta: {
...
export const extract_observation_bodyheight_from_Observation = (resource: Observation): observation_bodyheight => {
    ...
    return {
        ...
        code: resource.code,
        subject: resource.subject as observation_bodyheight['subject'],
