...
export const attach_observation_bodytemp_to_Observation = (resource: Observation, profile: observation_bodytemp): Observation => {
    return {
        ...resource,
        meta: {
...
export const extract_observation_bodytemp_from_Observation = (resource: Observation): observation_bodytemp => {
    ...
    return {
        ...
        code: resource.code,
        subject: resource.subject as observation_bodytemp['subject'],
